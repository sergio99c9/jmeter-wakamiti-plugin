...
Característica: : jmeter demo
   ...
   #    Dada la URL base 'https://iam-pre.consum.es/commonauth'
   #    Y se realiza un POST usando un fichero con los siguientes datos './src/test/resources/usuariosLogin.csv' trabajando con las variables:
   #      |variables|
   #      |username|
   #      |password|
   #    Cuando se ejecuta una prueba de carga con 5 usuarios durante 1 minutos
   #    Entonces comprueba que el percentil 99 de tiempo de respuesta es menor que 5 segundos
